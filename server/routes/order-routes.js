...
router.delete('/remove', checkShiftRoleMiddleware("manager"), orderController.remove)
...
router.delete('/item/remove', checkShiftRoleMiddleware("manager"), orderController.deleteItem)
